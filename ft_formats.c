...
/*   Updated: 2023/05/10 17:48:49 by jpes             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_formats(va_list args, const char format)
{
	...
	if (format == 'c')
		...
		print_length += ft_print_p(va_arg(args, void *));
		else if (format == 'd' || format == 'i')
		print_length += ft_print_d_i(va_arg(args, int), print_length);
		else if (format == 'u')
		print_length += ft_print_u(va_arg(args, unsigned int), print_length);
		else if (format == 'x')
		print_length += ft_print_x(va_arg(args, unsigned int), print_length);
		else if (format == 'X')
		print_length += ft_print_up_x(va_arg(args, unsigned int), print_length);
		else if (format == '%')
